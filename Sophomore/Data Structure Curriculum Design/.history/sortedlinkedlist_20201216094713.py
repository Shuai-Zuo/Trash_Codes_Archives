...
if __name__=='__main__':
    ...
    sll.insert_by_rating(test('8.7'))
    sll.insert_by_rating(test('7.1'))
    sll.insert_by_rating(test('9.7'))
    sll.insert_by_rating(test('8.2'))
    sll.insert_by_rating(test('8.4'))
    sll.insert_by_rating(test('8.1'))
    sll.insert_by_rating(test('8.1'))
    sll.insert_by_rating(test('8.1'))
    pass