...
class Search():
    def __init__(self):
        ...
        for word in self.words:
            ...
            if self.avl.contains(wd[0]):
                ...
                import_film=film(wd[0],wd[1],wd[2],wd[3],wd[4],wd[5],wd[6],wd[7],wd[8],wd[9],wd[10],wd[11])
    ...
    def refresh_list(self,linkedlist, films):
        for film in films:
            linkedlist.delete(film.film_name)
            linkedlist.insert_by_clicks(film.film)

    def refresh_list_external(self,linkedlist, film):
