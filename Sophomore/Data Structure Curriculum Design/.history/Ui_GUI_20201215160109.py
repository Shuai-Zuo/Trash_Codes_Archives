...
class Ui_FSS(object):
    ...
    def retranslateUi(self, FSS):
        ...
        self.textBrowser.setHtml(_translate("FSS", 
"11321"
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><a href=\"https://blog.csdn.net/wjj1996825/article/details/80924555\"><span style=\" text-decoration: underline; color:#0000ff;\">aa</span></a></p>"))
