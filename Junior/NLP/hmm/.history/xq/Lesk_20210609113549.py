...
print(sent_cut)
wsd_dict = {}
for fil in os.listdir('C:\\Users\\admin\\Downloads\\wordcut_hmm-master\\xq'):
    if wsd_word in fil:
        wsd_dict[fil.replace('.txt', '')] = read_file('C:\\Users\\admin\\Downloads\\wordcut_hmm-master\\xq\\'+fil)
# 统计每个词语在语料中出现的次数
tf_dict = {}
...
print('\n经过词义消岐，%s在该句子中的意思为 %s .' % (wsd_word, '1' '''true_meaning'''))